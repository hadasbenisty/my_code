%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% A script for analyzing the new results of D30 - tiling, behavioral and
% connectivity by Tal
%
%
% Written by Hadas Benisty, 9/14/2016
...
nt = 360;
files = {'8_12_14_1-40'  '8_15_14_b'  '8_15_14_1-35' '8_17_14_1-45'  };%
...
[Trees_all, currSolutionTiling_all, neurons_order_all, time_order_all, dual_aff_all, meanDataLog_all] = runQuestAndTile(X_N_all, params, p1, runningOrder);
% plotTilingByBehave(meanDataLog_all, X_NN, eventNameList, behaveDataProc, roiLocs_all, ...
%     neurons_order_all, time_order_all, currSolutionTiling_all, 'All Data', t(toneTimeFramesExrtazoom), animalName, behave_events_times_all, allLabels,'');

...
% analysisDir         = 'C:\Users\mayahar\Documents\maya-research\Questionnaire\Data\D8\8_14_14\1-35_control_500mic\';
...
for trialIndShow = 1:min(fileNumRoi,fileNumEvent)
%%%
...
subplot(223);imagesc(dffDataArray)
subplot(224);imagesc(eventDataArray)
